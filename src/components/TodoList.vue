<template>
  <div class="tasks">
    <div class="tasks__wrapper">
      <template v-if="areItemsLoaded && finalItems.length > 0">
        <TodoItem v-for="item in finalItems" :key="item.id" :item="item" />
      </template>
      <template v-else-if="areItemsLoaded && finalItems.length === 0">
